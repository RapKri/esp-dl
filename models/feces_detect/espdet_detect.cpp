...
extern const uint8_t feces_detect_espdl[] asm("_binary_feces_detect_espdl_start");
static const char *path = (const char *)feces_detect_espdl;
...
{
    switch (model_type) {
    case model_type_t::ESPDET_PICO_224_224_FECES:
#if CONFIG_FLASH_ESPDET_PICO_224_224_FECES || CONFIG_FECES_DETECT_MODEL_IN_SDCARD
        m_model = new espdet_detect::ESPDet("espdet_pico_224_224_feces.espdl");
#else
        ESP_LOGE("feces_detect", "espdet_pico_224_224_feces is not selected in menuconfig.");
#endif
        break;
    }
}
